...
'changequote`'')
changecom()dnl
syscmd(`tmux -V | check_version -q -r "tmux [a-z-]*([0-9]+\.[0-9]+)" -c 3.1')dnl
...
syscmd(`tmux -V | check_version -q -r "tmux [a-z-]*([0-9]+\.[0-9]+)" -c 2.4')dnl
ifelse(sysval, `0', `dnl
...
syscmd(`tmux -V | check_version -q -r "tmux [a-z-]*([0-9]+\.[0-9]+)" -c 3.0')dnl
...
syscmd(`tmux -V | check_version -q -r "tmux [a-z-]*([0-9]+\.[0-9]+)" -c 2.9')dnl
